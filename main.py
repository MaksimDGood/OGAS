...
async def cmd_help_ogas(message: types.Message):
    ...
    help_text = (
        ...
        "📌 _Примечание: В базовых настройках минимальная явка состовляет 15% от участников чата, а порог прохождения на выборах администраторов составляет 30%, время проведения опросов 24 часа._"
    )
